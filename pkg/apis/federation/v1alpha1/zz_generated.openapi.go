...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/raffaelespazzoli/openshift-namespace-federation-operator/pkg/apis/federation/v1alpha1.ClusterDeploymentSet":              schema_pkg_apis_federation_v1alpha1_ClusterDeploymentSet(ref),
		"github.com/raffaelespazzoli/openshift-namespace-federation-operator/pkg/apis/federation/v1alpha1.ClusterDeploymentSetSpec":          schema_pkg_apis_federation_v1alpha1_ClusterDeploymentSetSpec(ref),
		"github.com/raffaelespazzoli/openshift-namespace-federation-operator/pkg/apis/federation/v1alpha1.ClusterDeploymentSetStatus":        schema_pkg_apis_federation_v1alpha1_ClusterDeploymentSetStatus(ref),
...
func schema_pkg_apis_federation_v1alpha1_ClusterDeploymentSet(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/raffaelespazzoli/openshift-namespace-federation-operator/pkg/apis/federation/v1alpha1.ClusterDeploymentSetSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/raffaelespazzoli/openshift-namespace-federation-operator/pkg/apis/federation/v1alpha1.ClusterDeploymentSetStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/raffaelespazzoli/openshift-namespace-federation-operator/pkg/apis/federation/v1alpha1.ClusterDeploymentSetSpec", "github.com/raffaelespazzoli/openshift-namespace-federation-operator/pkg/apis/federation/v1alpha1.ClusterDeploymentSetStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_pkg_apis_federation_v1alpha1_ClusterDeploymentSetSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					"template": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/raffaelespazzoli/openshift-namespace-federation-operator/pkg/apis/federation/v1alpha1.ClusterDeploymentTemplate"),
						},
					},
					"replicas": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/raffaelespazzoli/openshift-namespace-federation-operator/pkg/apis/federation/v1alpha1.ClusterDeploymentTemplate"},
	}
}
